...
export const description =
  "A full-screen login page with two columns in dark mode. The first column has the login form with email and password. There's a Forgot your password link and a link to sign up if you do not have an account. The second column is an empty space for displaying an ID card.";
